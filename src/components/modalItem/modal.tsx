      ...
      <div className="bg-white p-10 rounded-3xl flex flex-col gap-5 items-center">
        ...
        <>
          ...
          <button
            ...
            className="mt-8 rounded-3xl bg-green text-xl border-none w-[280px] h-[52px]"
          >
            Войти
          </button>
          <button className="rounded-3xl border-2 text-xl w-[280px] h-[52px]">
            Зарегистрироваться
          </button>
        </>
        {/* ) : (
          <>
            ...
            <input
              ...
              className="py-4 px-5 outline-none border-[rgba(208,206,206,1)] border-2 rounded-lg text-lg w-[280px] h-[55px]"
            />
            <button className="mt-8 rounded-3xl bg-green text-xl border-none w-[280px] h-[52px]">
              Зарегистрироваться
            </button>
            <button
